...
| idx/4byte | sample     | property     | detail               |
| --------- | ---------- | ------------ | -------------------- |
| 0         | 0x000000ff | 检测序列号   | 工位                 |
| 1         | N          | 蒙版个数     | 2                    |
| 2         | 0x0000001  | 循环检测标志 | 1==循环；0==只检一次 |
| 3         | 0x000000   | 0号蒙版      | 蒙版序号             |
| 4         | 0xffffffff | 0号蒙版      | Global 上门限        |
| 5         | 0xffffffff | 0号蒙版      | Global 下门限        |
| 6         | 0xffffffff | 0号蒙版      | Row  上门限          |
| 7         | 0xffffffff | 0号蒙版      | Row 下门限           |
| 8         | 0xffffffff | 0号蒙版      | Col  上门限          |
| 9         | 0xffffffff | 0号蒙版      | Col 下门限           |
| 10        | 0x000000   | 0号蒙版      | 工作模式             |
| 11        | 0x000001   | 1号蒙版      | 蒙版序号             |
| 12        | 0x0000ff   | 1号蒙版      | Global 上门限        |
| 13        | 0x0000ff   | 1号蒙版      | Global 下门限        |
| 14        | 0x0000ff   | 1号蒙版      | Row  上门限          |
| 15        | 0x0000ff   | 1号蒙版      | Row 下门限           |
| 16        | 0x0000ff   | 1号蒙版      | Col  上门限          |
| 17        | 0x0000ff   | 1号蒙版      | Col 下门限           |
| 18        | 0x000000   | 1号蒙版      | 工作模式             |
| ...       | ....       | ...          | ...                  |
